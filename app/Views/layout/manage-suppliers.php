        ...
        <div class="col-xs-12">
          ...
          <div class="box box-info" style="overflow: auto;">
            <div class="box-header">
              <h3 class="box-title" style="padding-top: 10px;"> All Supplier Details</h3>
            </div>
            <!-- /.box-header
                  onclick="window.location.href = 'add-client.php'";
             -->

             <button type="button" id="btnplus add" class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#modal-default" style="margin: 2px 20px 2px 2px;" ><span class="glyphicon glyphicon-plus"></span>&nbsp; Add Supplier</button><br><br>
            ...
            <!-- form start -->
              ...
              <div class="box-body">  
                <div class="form-group">
                  <label id="cidlbl" class="col-sm-3 control-label">Supplier ID</label>
                  <div class="col-sm-8">
              ...
              <div class="form-group">
                ...
                <div class="form-group has-danger">
                  <label id="moblbl" class="col-sm-3 control-label">Mobile <span style="color: red;">*</span></label>
                    <div class="col-sm-8">
            ...
            <!-- form start -->
              ...
              <div class="box-body">  
               ...
               <div class="form-group">
                ...
                <div class="form-group has-danger">
                  <label id="moblbl2" class="col-sm-3 control-label">Mobile <span style="color: red;">*</span></label>
                    <div class="col-sm-8">
