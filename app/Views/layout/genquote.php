        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
           ...
           <p align="center" style="color:#F00;"></p>
                      ...
                      <form class="form-horizontal style-form form" name="form" id="form"  method="post" action="<?= base_url();?>/quote/insert">
...
<script type="text/javascript" src="<?= base_url(); ?>/public/jslogic/genquote.js"></script>
</body>
</html>
