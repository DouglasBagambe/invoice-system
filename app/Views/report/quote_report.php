                      ...
                      <div class="box">
                        <div class="box-body">                                                 
                          ...
                          <div  class="btn-group" data-toggle="buttons" role="group">
                                  ...
                                  <input type="button" class="toggle-vis btn btn-primary" data-column="1" value="Quote No.">
                                  <input type="button" class="toggle-vis btn btn-primary" data-column="2" value="Quote Date">
...
var globalSubtotalTotal=0;
    function loadInvoices(date = null, client = null,ctype=null) {
        ...
        $.ajax({
            url: base_url + '/quote/loadinvoices',
            type: 'GET',
            data: { 
                    date: date,
                    client: client,
