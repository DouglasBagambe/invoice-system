            ...
            <?php if($records2): ?>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <label id="ccid" class="col-sm-2 control-label">Invoice ID <span style="color: red;">*</span></label>
                  <div class="col-sm-3">
                    <input type="text" class="form-control" name="invid" id="invid" value="">
                    <div id="invid_error" style="color: red;"> </div>
                  </div>
                      <label id="c_addlbl1" class="col-sm-2 control-label">Supplier Name <span style="color: red;">*</span></label>
