        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
           ...
           <p align="center" style="color:#F00;"></p>
                      ...
                      <form class="form-horizontal style-form form" name="form" id="form"  method="post" action="<?= base_url();?>/quote/updatequote">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <label id="ccid" class="col-sm-2 control-label">Quote ID</label>
                  <div class="col-sm-3">
                    <input type="text" class="form-control" name="invid" id="invid" value="">
                    <div id="invid_error" style="color: red;"> </div>
                  </div>
                      <label id="c_addlbl1" class="col-sm-2 control-label">Client/Supplier Name <span style="color: red;">*</span></label>
    
                    <div class="col-sm-4">
                     <select name="supplier" id="supplier" class="form-control select2" onchange="showCustomer(this.value)" style="width: 80%;border-radius:0px; ">
                                 <option></option>
                                  
                          </select>
                          <!-- <button type="button" id="btnplus" class="btn btn-success btn-sm" onclick="window.location.href = 'add-supplier.php'";><span class="glyphicon glyphicon-plus"></span></button> --><br>
...
<!-- <hr> --> </br>
      ...
      <tr>
        <th width="2%"><input id="checkAll" class="formcontrol" type="checkbox"></th>
              ...
              <th width="30%">Item Name <span style="color: red;">*</span></th>
              <!-- <th width="20%">Description Name</th>
              <th width="10%">HSN </th> --> 
              <th width="10%">Quantity <span style="color: red;">*</span></th>
              <th width="20%">Price <span style="color: red;">*</span></th>                
...
$('#supplier').on('select2:select', function (e) {
 ...
 window.showCustomer = function showCustomer(str) {
    ...
    $.ajax({
        url: base_url + "/quote/editquote/" + orderId,
        type: "GET",
        dataType: "json",
        success: function (response) {
            ...
            response.records.forEach(function (record, index) {
                ...
                <tr class="datarow">
                    ...
                    <td>
                        <select name="item_name[]" id="productName_${count}" class="form-control item_name select2" style="width:100%; height:45px !important;">
...
if (hasError) {
    return;
        ...
        $.ajax({
            type: "POST",
            url: base_url + "/quote/updatequote/" + orderId,
            data:formData,
            dataType: 'json', 
            //contentType: false,           
            success: function(response) {
