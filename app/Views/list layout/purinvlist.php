      ...
      <div class="row">
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover" id="pinvoices" name="pinvoices">
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.invoices && Array.isArray(response.invoices)) {
                    $('#pinvoices').empty(); // Clear previous data

                    response.invoices.forEach(function(invoice) {
                        var html = `
                            <a href="printpurchaseinv?orderid=${invoice.orderid}" target="_blank">
